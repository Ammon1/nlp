...
counter=0
import newspaper
polsat_paper = newspaper.build('https://polsatnews.pl')
...
my_file = r"C:\Users\Lenovo\articles\links_polsatnews.txt"
...
for link in links:
    ...
    for article in polsat_paper.articles:
        ...
        for article1 in new_list.articles:
                    print('1')
                    new_paper1=article1.url
                    if 'polsatnews' in new_paper1 and new_paper1 not in papers:
                        links.append(new_paper1)
                        counter=+1
                        print('art ',counter)
